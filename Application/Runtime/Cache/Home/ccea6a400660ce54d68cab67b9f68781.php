...
<link href="<?php echo _Root_;?>BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url('<?php echo _Root_;?>Public/images/loginbg_07.jpg') no-repeat center center fixed;
...
<![endif]-->
<div class="main_box">
    <div class="setting"><a href="javascript:;"  title="更换背景"><span class="glyphicon glyphicon-th-large"></span></a></div>
	<div class="login_box">
        <div class="login_logo" style="color:#fff;font-size:25px;">
        ...
        <div class="login_form">
    		...
    		<form action="<?php echo U('logining');?>" id="login_form" method="post">
    			...
    			<div class="form-group">
    				...
    				<img id="captcha_img" onclick="change_img(this)" alt="点击更换" title="点击更换" src="<?php echo U('Verify');?>" class="m">
    			</div>
	...
	<div class="bottom">Copyright &copy; 2013 - 2014 <a href="http://www.035k.com" target="_blank">龙飞工作室</a></div>
</div>
<script type="text/javascript">
function change_img(_this){
    _this.src="<?php echo U('Verify');?>?rand="+Math.ceil(Math.random()*1000);
}
</script>
</body>
</html>